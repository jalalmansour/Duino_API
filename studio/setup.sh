...
echo -e "${BOLD}${GREEN}╚══════════════════════════════════════════╝${NC}"
echo ""
echo -e "  Next step (notebook): ${CYAN}from studio.backend.colab import start; result = start()${NC}"
echo -e "  CLI deploy          : ${CYAN}duinobot deploy${NC}"
echo -e "  CLI serve           : ${CYAN}duinobot serve${NC}"
echo -e "  Public URL          : ${YELLOW}Shown after start() — auto-generated HTTPS link${NC}"
echo ""
